...
class UnitTests(unittest.TestCase):
  ...
  def test_sentence_to_ipa_no_replace_unknown_keep_original(self):
    ...
    res = self.sentence_to_ipa.sentence_to_ipa("to to. xxl xxl.", replace_unknown_with=None)
  ...
  def test_sentence_to_ipa_replace_unknown_with_underscore(self):
    ...
    res = self.sentence_to_ipa.sentence_to_ipa("to to. xxl xxl.", replace_unknown_with="_")
  ...
  def test_sentence_to_ipa_replace_unknown_with_nothing(self):
    ...
    res = self.sentence_to_ipa.sentence_to_ipa("to to. xxl xxl.", replace_unknown_with="")
  ...
  def test_sentence_to_ipa_replace_unknown_with_custom_func(self):
    ...
    res = self.sentence_to_ipa.sentence_to_ipa("to to. xxl xxl.", replace_unknown_with=lambda x: x + "X")
  ...
  def test_sentence_to_ipa__double_space__is_kept(self):
    ...
    res = self.sentence_to_ipa.sentence_to_ipa("to  to", replace_unknown_with="_")

    self.assertEqual("tˈu  tˈu", res)

  def test_sentence_to_ipa__single_punctuation__is_kept(self):
    # should return .
    res = self.sentence_to_ipa.sentence_to_ipa(".", replace_unknown_with="_")
  ...
  def test_sentence_to_ipa__too_long_replacement__throws_exception(self):
    ...
    try:
      self.sentence_to_ipa.sentence_to_ipa("to", replace_unknown_with="__")
      self.fail()
  ...
  def test_sentence_to_ipa__minus_sign(self):
    ...
    res = self.sentence_to_ipa.sentence_to_ipa("to-to-to", replace_unknown_with="_")
  ...
  def test_sentence_to_ipa__minus_sign_different_words(self):
    ...
    res = self.sentence_to_ipa.sentence_to_ipa("to-no-so", replace_unknown_with="_")
  ...
  def test_get_ipa_of_word_in_sentence__minus_is_kept(self):
    ...
    res = self.sentence_to_ipa.get_ipa_of_word_in_sentence("-", replace_unknown_with="_")

    self.assertEqual("-", res)

  def test_get_ipa_of_word_in_sentence__single_quotation_mark_is_kept(self):
    # should return ipa of to with ' at beginning
    res = self.sentence_to_ipa.get_ipa_of_word_in_sentence("'to", replace_unknown_with="_")
  ...
  def test_get_ipa_of_word_in_sentence__minus_sign_and_parenthesis(self):
    ...
    res = self.sentence_to_ipa.get_ipa_of_word_in_sentence("(to-to-to)", replace_unknown_with="_")
  ...
  def test_get_ipa_of_word_in_sentence__big_letter_abbreviation(self):
    ...
    res = self.sentence_to_ipa.get_ipa_of_word_in_sentence("PRS", replace_unknown_with="_")
  ...
  def test_sentence_to_ipa__mix_of_different_scenarios(self):
    ...
    res = self.sentence_to_ipa.sentence_to_ipa("((to-?PRS --to xxl))", replace_unknown_with="_")
  ...
  def test_get_ipa_of_word_in_sentence__allo(self):
    ...
    res = self.sentence_to_ipa.get_ipa_of_word_in_sentence("'Allo", replace_unknown_with="_")
  ...
  def test_get_ipa_of_word_in_sentence__theyre(self):
    ...
    res = self.sentence_to_ipa.get_ipa_of_word_in_sentence("they're", replace_unknown_with="_")
  ...
  def test_get_ipa_of_word_in_sentence__cat_o_nine_tails(self):
    ...
    res = self.sentence_to_ipa.get_ipa_of_word_in_sentence("cat-o-nine-tails", replace_unknown_with="_")
  ...
  def test_get_ipa_of_word_in_sentence__to_cat_o_nine_tails_to(self):
    ...
    res = self.sentence_to_ipa.get_ipa_of_word_in_sentence("to-cat-o-nine-tails-to", replace_unknown_with="_")
  ...
  def test_get_ipa_of_word_in_sentence__ha_ha_ha(self):
    ...
    res = self.sentence_to_ipa.get_ipa_of_word_in_sentence("ha-ha-ha", replace_unknown_with="_")
  ...
  def test_get_ipa_of_word_in_sentence__day_by_day_to_day(self):
    ...
    res = self.sentence_to_ipa.get_ipa_of_word_in_sentence("day-by-day-to-day", replace_unknown_with="_")
  ...
  def test_get_ipa_of_word_in_sentence__end_inner_quote(self):
    ...
    res = self.sentence_to_ipa.get_ipa_of_word_in_sentence("'end-inner-quote", replace_unknown_with="_")
  ...
  def test_get_ipa_of_word_in_sentence__cat_o_nine_tails_to_with_punctuation(self):
    ...
    res = self.sentence_to_ipa.get_ipa_of_word_in_sentence("'cat-o-nine-tails-to", replace_unknown_with="_")
  ...
  def test_sentence_to_ipa__sentence_with_apos(self):
    ...
    res = self.sentence_to_ipa.sentence_to_ipa("'Allo, to they're?", replace_unknown_with="_")
  ...
  def test_get_ipa_of_word_in_sentence__stones_genitive(self):
    ...
    res = self.sentence_to_ipa.get_ipa_of_word_in_sentence("stones'", replace_unknown_with="_")
  ...
  def test_get_ipa_of_word_in_sentence__no_brainer(self):
    ...
    res = self.sentence_to_ipa.get_ipa_of_word_in_sentence("no-brainer", replace_unknown_with="_")

    self.assertEqual("nˌoʊbɹˈeɪnɝ", res)

  def test_sentence_to_ipa__etc(self):
    # dict only contains ETC but not ETC.
    res = self.sentence_to_ipa.sentence_to_ipa("etc.", replace_unknown_with="_")
