...
class UnitTests(unittest.TestCase):
  ...
  def test_sentence_to_ipa__cat_o_nine_tails(self):
    ...
    res = self.cmu_dict.sentence_to_ipa("cat-o-nine-tails", replace_unknown_with="_")
  ...
  def test_sentence_to_ipa__to_cat_o_nine_tails_to(self):
    ...
    res = self.cmu_dict.sentence_to_ipa("to-cat-o-nine-tails-to", replace_unknown_with="_")
  ...
  def test_sentence_to_ipa__ha_ha_ha(self):
    ...
    res = self.cmu_dict.sentence_to_ipa("ha-ha-ha", replace_unknown_with="_")
  ...
  def test_sentence_to_ipa__day_by_day_to_day(self):
    ...
    res = self.cmu_dict.sentence_to_ipa("day-by-day-to-day", replace_unknown_with="_")
  ...
  def test_sentence_to_ipa__end_inner_quote(self):
    ...
    res = self.cmu_dict.sentence_to_ipa("'end-inner-quote", replace_unknown_with="_")
  ...
  def test_sentence_to_ipa__cat_o_nine_tails_to_with_punctuation(self):
    ...
    res = self.cmu_dict.sentence_to_ipa("'cat-o-nine-tails-to", replace_unknown_with="_")
  ...
  def test_sentence_to_ipa__stones_genitive(self):
    ...
    res = self.cmu_dict.sentence_to_ipa("stones'", replace_unknown_with="_")
  ...
  def test_sentence_to_ipa__no_brainer(self):
    ...
    res = self.cmu_dict.sentence_to_ipa("no-brainer", replace_unknown_with="_")
